# Agent Instructions — Installable
...
This module is intentionally minimal — it is a reusable building
block, decoupled from any consuming project per Helix Constitution
§11.4.28. No project-specific context is injected here.
